...
* Added `check_time_intervals_start_time_all_zero` to flag TimeIntervals tables where all start_time values are 0, indicating times were likely not set relative to session start. [#677](https://github.com/NeurodataWithoutBorders/nwbinspector/issues/677)
