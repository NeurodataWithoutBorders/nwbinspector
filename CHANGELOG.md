...
* Added support for Python 3.14 and bumped the CI "latest Python" matrix pins from 3.13 to 3.14. [#713](https://github.com/NeurodataWithoutBorders/nwbinspector/pull/713)
